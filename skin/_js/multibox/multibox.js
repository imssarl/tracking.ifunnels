...
var multiBox = new Class({
	...
	start: function(){
		...
		if(this.multiBox.length == 1||this.options.nobuttons){
	...
	setContentType: function(element){
		...
		switch(str){
			...
			case 'element':
				...
				if(this.contentObj.height=='auto'){
					this.contentObj.flg_auto=1;
				}
	...
	showContent: function(){
		...
		this.contentContainer = new Element('div', {
			...
			'styles': {
				opacity: 0,
				width: this.contentObj.width,
				height: (this.contentObj.flg_auto)?'':(Number(this.contentObj.height)+this.contentObj.xH)
			}
