<?php
...

	{
...

		{
			...
			if($_GET["sort"]==''){$order_type = "DESC";}else{$order_type = $_GET["sort"];}



			if(isset($_GET["sortf"]) && $_GET["sortf"] != "")


			{


				$order_field_name = $_GET["sortf"];
			...
			if($order_field_name==''){$order_field_name=='';}else{$order_field_name=='updatedate';}			
