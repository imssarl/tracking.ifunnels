...

{
	...
	function pingFeedXML($title, $arturl, $guid,  $feedurl)

	{

		//require_once("admin-hooks.php");  // files not available

		//require_once("../config.inc.php"); // files not available
		...
		*/ // unnessesory code is commented my mahendra
		...
		$pinger->ping_all($title, $arturl, $guid, $feedurl);

		

		//$ping1 = fetch_admin($pingomatic); // no function found with this name

		//$ping2 = fetch_admin($pingoat); // no function found with this name

		

//		echo "<br /> Pinging : Done! All <strong>pings</strong> have been sent!";
