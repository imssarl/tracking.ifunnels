...
//    var $weblogs_com_method = "weblogUpdates.rssUpdate"  ;    
...
//    var $blo_gs_path = "/";
    ...
    var $blo_gs_server = "ping.feeds.yahoo.com";

    var $blo_gs_path = "/RPC2";
    ...
    var $blo_gs_extended_method = "weblogUpdates.extendedPing";	 // by mahendra
...
//    var $technorati_method = "weblogUpdates.rssUpdate";

    var $technorati_method = "weblogUpdates.ping";

    

    var $technorati_extended_method = "weblogUpdates.extendedPing";	 // by mahendra
    ...
    function report_error($message) {
		...
		global $mail,$user_data;

		$matr = "Dear ".$user_data["username"].",

		

		Control Panel found some errors in pinging : 
		...
		$mail->From = "Controlpanel";

		$mail->FromName = "Controlpanel";
		...
		echo "<br>Pinging error : ".$this->technorati_method.$message;
    ...
    function ping_blo_gs_extended($weblog_name, $weblog_url, $changes_url, $rss_url) {

        if ($this->debug) $this->report_error(

            "Sending extended ping to blo_gs for "

            . "$weblog_name, $weblog_url, $changes_url, $rss_url");

        return $this->ping($this->blo_gs_server, $this->blo_gs_port,

            $this->blo_gs_path, $this->blo_gs_extended_method, $weblog_name,
    ...
    function ping_technorati_extended($weblog_name, $weblog_url, $changes_url, $rss_url) {

        if ($this->debug) $this->report_error(

            "Sending extended ping to technorati.Com for "

            . "$weblog_name, $weblog_url, $changes_url, $rss_url");

        return $this->ping($this->technorati_server, $this->technorati_port,

            $this->technorati_path, $this->technorati_extended_method, $weblog_name,
...
//        $error[2] = $this->ping_blo_gs_extended($weblog_name, $weblog_url, $changes_url, $category);
    ...
    function ping($xml_rpc_server, $xml_rpc_port, $xml_rpc_path, $xml_rpc_method,
		...
		// $extended = false was set by default, mahendra changed it to true.
