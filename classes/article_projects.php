...
document.writeln('<input type="button" name="proc" value="Continue" onclick="javascript: location = \'projects.php?which_site=0&which_project=all&msg=New article project has been added\'" />');
			...
			document.getElementById("importtextzipdiv").style.display = 'none';
				...
				try
				  ...
				  xmlHttp.onreadystatechange=function()
					...
					document.getElementById("article_format_tr").style.display='block';
...
function rand_no(theElement)
{
		...
		while(z<txt){
	        ...
	        {
				  //alert("I m a cchkbox "+n);	
				  if(tForm[n].checked==true){
				  	tForm[n].checked =false;
					z=z-1;
				  }
				  else{
					tForm[n].checked =true;
...

{
  ...
  // function for check the  changes on 15 nov 
...
<div id="article_format_tr" style="display:none;width:300px;">Article Format:<input type="radio" name="article_format" id="article_format" value="Y"> Same Format as NCSB Sites
</div>			
