...
function smarty_function_view( $_arrPrm, &$objS ) {
	...
	Core_Parsers_Smarty::getInstance()->template( $strRes, $_arrPrm, Zend_Registry::get( 'config' )->path->relative->source.'stencil_view/stencil_view.tpl' );
	return $strRes;
}
?>