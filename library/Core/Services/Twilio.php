 ...
 */
class Core_Services_Twilio extends Core_Services_Twilio_Resource
{
     ...
     * @param Core_Services_Twilio_Http $_http    A HTTP client
    ...
    public function __construct(
        ...
        $token,
        $version = null,
        Core_Services_Twilio_TinyHttp $_http = null,
        $retryAttempts = 1
    ) {
        ...
        if (null === $_http) {
            ...
            $_http = new Core_Services_Twilio_TinyHttp(
...
//                    CURLOPT_CAINFO => dirname(__FILE__) . '/cacert.pem',
        ...
        $this->http = $_http;
        $this->accounts = new Core_Services_Twilio_Rest_Accounts($this, "/{$this->version}/Accounts");
     ...
     * @throws Core_Services_Twilio_RestException (Response in 300-500 class)
     */
