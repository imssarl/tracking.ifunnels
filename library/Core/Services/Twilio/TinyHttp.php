...
class Core_Services_Twilio_TinyHttpException extends ErrorException {}

class Core_Services_Twilio_TinyHttp {
  ...
  public function __call($name, $args) {
    ...
    case 'put':
      ...
      if (strlen($req_body)) {
        ...
        } else throw new Core_Services_Twilio_TinyHttpException('unable to open temporary file');
      }
      break;
    case 'head':
        ...
        if (curl_setopt_array($curl, $opts)) {
          if ($response = curl_exec($curl)) {
            ...
            return array($status, $headers, $body);
              ...
              throw new Core_Services_Twilio_TinyHttpException(curl_error($curl));
          }
        } else throw new Core_Services_Twilio_TinyHttpException(curl_error($curl));
      } else throw new Core_Services_Twilio_TinyHttpException('unable to initialize cURL');
