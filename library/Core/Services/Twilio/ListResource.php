 ...
 *
 * @category Services
 * @package  Core_Services_Twilio
 * @author   Neuman Vong <neuman@twilio.com>
 * @license  http://creativecommons.org/licenses/MIT/ MIT
 * @link     http://pear.php.net/package/Core_Services_Twilio
 */
abstract class Core_Services_Twilio_ListResource
    extends Core_Services_Twilio_Resource
    implements IteratorAggregate, Countable
{
    ...
    public function __construct($client, $uri) {
        ...
        if (!isset($this->instance_name)) {
            $this->instance_name = "Core_Services_Twilio_Rest_" . rtrim($name, 's');
        }
     ...
     * @return Core_Services_Twilio_InstanceResource The resource
     */
     ...
     * @return Core_Services_Twilio_InstanceResource An instance with properties 
     ...
     *
     * @return Core_Services_Twilio_InstanceResource The created resource
     */
     ...
     *
     * @return Core_Services_Twilio_Page A page
     */
    public function getPage(
        ...
        return new Core_Services_Twilio_Page($page, $list_name, $next_page_uri);
    }
     ...
     *
     * @return Core_Services_Twilio_AutoPagingIterator An iterator
     */
    public function getIterator(
        $page = 0, $size = 50, array $filters = array()
    ) {
        return new Core_Services_Twilio_AutoPagingIterator(
