...
class Core_Services_Twilio_Rest_UsageTriggers extends Core_Services_Twilio_ListResource {
     ...
     * @return Core_Services_Twilio_Rest_UsageTrigger The created trigger
     */
