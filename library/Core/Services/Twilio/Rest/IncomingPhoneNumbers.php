...
class Core_Services_Twilio_Rest_IncomingPhoneNumbers
    extends Core_Services_Twilio_ListResource
{
     ...
     * @return Core_Services_Twilio_Rest_IncomingPhoneNumber|null The number object, 
     *      or null
     * 
     * @throws Core_Services_Twilio_RestException if the number is invalid, not 
