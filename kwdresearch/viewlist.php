...
<!--
	function doDelete(x,y){
		...
		if(confirm("Are you sure to delete the keyword?")){
...
<table style='border:solid; border-width:1px; border-color:#666666' cellpadding=0 cellspacing=2 width = '90%' align='center'>
	...
	<tr style='background:<?php echo $xcolor?>'>
		...
		<td ><font color='#000000'><?php echo $data['keyword'];?></font></td>
		<td width='20'><img src="../images/delete.png" onClick="doDelete('<?php echo $data['kwdid'];?>','<?php echo $_GET['xid'];?>');" title="Delete Keyword" style="cursor:pointer"></td>
		</tr>
	<?php
		$sno++;
		}
