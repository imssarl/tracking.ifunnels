...
//		}
//
//		$order_sql = $sc->getOrderSql(array("id","author","date_created"),"id");
...
<table width="80%"  border="0" cellspacing="0" cellpadding="0"  align="center">
			<tr>
				<td valign = "top" align="center" class="heading"><a href="?process=add" class="menu">Add a new article</a> | <a href="#" class="menu">Manage Category</a> | <a href="?process=import" class="menu">Mass Import </a> | <a href="?process=rss" class="menu">Import through Rss </a></td>
			</tr>
			<br>
			<tr>
				<td colspan="6">
...
<table border="0" cellspacing="1" cellpadding="1" align="center" class="summary">
		...
		<tr id="row<?php echo $id; ?>"  class='<?php echo ($tblmat++%2) ? "tablematter1" : "tablematter2" ?>' >
			...
			<td align="center"><a href="#" onclick="opencode('<?php echo $id;?>','article')" style="cursor:pointer"><?php echo $article['title'];?></a></td>
