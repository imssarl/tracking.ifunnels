...
<tr {if $k%2=='0'} class="matros"{/if}>
	...
	<td class="option">
		<a href="{url name='site1_psb' action='templates'}?delete={$v.id}">del</a>
	</td>
</tr>
{/foreach}
</tbody>
