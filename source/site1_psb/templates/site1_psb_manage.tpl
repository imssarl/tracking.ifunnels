...
<tr>
	<th>Last Modify
		{if $arrPg.recall>1}
			{if $arrFilter.order!='edited--up'}<a href="{url name='site1_psb' action='manage' wg='order=edited--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='edited--dn'}<a href="{url name='site1_psb' action='manage' wg='order=edited--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}
	</th>
	<th>Template Used
		{if $arrPg.recall>1}
			{if $arrFilter.order!='temp_id--up'}<a href="{url name='site1_psb' action='manage' wg='order=temp_id--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='temp_id--dn'}<a href="{url name='site1_psb' action='manage' wg='order=temp_id--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}
	</th>
	<th>Main Keyword
		{if $arrPg.recall>1}
			{if $arrFilter.order!='main_keyword--up'}<a href="{url name='site1_psb' action='manage' wg='order=main_keyword--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='main_keyword--dn'}<a href="{url name='site1_psb' action='manage' wg='order=main_keyword--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}
	</th>
	<th>Category
		{if $arrPg.recall>1}
	...
	<th>Site URL
		{if $arrPg.recall>1}
			{if $arrFilter.order!='url--up'}<a href="{url name='site1_psb' action='manage' wg='order=url--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='url--dn'}<a href="{url name='site1_psb' action='manage' wg='order=url--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}
	</th>
...
<tr{if $k%2=='0'} class="matros"{/if}>
	...
	<td><img class="screenshot" rel="<div style='border:2px solid #000000;'><img src='{$preview}' /></div>" src="{img src=$preview w=95 h=60}{assign var=preview value=''}" /><br /></td>
	...
	<td class="option">
		<a href="{url name='site1_psb' action='edit'}?id={$v.id}"  id="{$v.id}" rel="{$v.category_id}"><img title="Edit" src="/skin/i/frontends/design/buttons/edit.png" /></a>
		<a href="{url name='site1_psb' action='edit'}?id={$v.id}&template=change"><img title="Change template" src="/skin/i/frontends/design/buttons/template.png" /></a>
		<a href="{url name='site1_psb' action='manage'}?del={$v.id}" id="delete"><img title="Delete" src="/skin/i/frontends/design/buttons/delete.png" /></a>
		<a href="{url name='site1_blogfusion' action='create'}?psb={$v.id}"><img title="Install Wordpress" src="/skin/i/frontends/design/buttons/wpinstall.gif" /></a>
