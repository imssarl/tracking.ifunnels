...
<fieldset>
	...
	<ol>
		...
		<li>
			<label>URL<em>*</em></label><input class="required" type="text" name="arrNvsb[url]" value="{$arrNvsb.url}">
		</li>
		<li>
			<label>Main Keyword <em>*</em></label><input class="required" type="text" name="arrNvsb[main_keyword]" value="{$arrNvsb.main_keyword}">
		</li>
			<li><label for="adsenseid">Adsense ID <em>*</em></label><input name="arrNvsb[adsense_id]" type="text" id="adsenseid" value="{$arrNvsb.adsense_id}" />
		</li>
		<li>
