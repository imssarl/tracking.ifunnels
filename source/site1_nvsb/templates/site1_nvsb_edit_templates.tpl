...
window.addEvent('domready', function(){
	$('select-file').addEvent('change', function(){
		...
		var r = new Request({  url:"{/literal}{url name='site1_nvsb' action='ajax_edit_template'}{literal}/?open_file=true", method:'post', onSuccess: function(response){
	...
	$('save-file').addEvent('click', function(){
		...
		var r = new Request({  url:"{/literal}{url name='site1_nvsb' action='ajax_edit_template'}{literal}/?save_file=true", method:'post', onSuccess: function(response){
