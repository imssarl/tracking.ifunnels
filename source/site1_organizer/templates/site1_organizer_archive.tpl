...
<table style="width:100%">
	...
	<tr{if $k%2!='0'} class="matros"{/if}>
		...
		<td align="center">
			...
			<a href="{url name='site1_organizer' action='archive'}?delete={$v.id}"><img title="Delete" src="/skin/i/frontends/design/buttons/delete.png" /></a>
			<a href="{url name='site1_organizer' action='archive'}?unarchive={$v.id}">Un-Archive</a>
		</td>
	</tr>	
	{/foreach}
	</tbody>
