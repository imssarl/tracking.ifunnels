	<ol>
		<li>
			...
			<input size="40" class="required" type="text" name="arrCnt[{$i.flg_source}][settings][id]" value="{if !empty($arrCnt.{$i.flg_source}.settings.id)}{$arrCnt.{$i.flg_source}.settings.id}{else}myid00001{/if}"/>
