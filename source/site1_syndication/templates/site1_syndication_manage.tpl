<br/>
{if $msg == 'delete'}
<div class="grn">Project has been deleted</div>
{elseif $msg=='delete_error'}
<div class="red">Project can't be deleted</div>
{elseif $msg=='created'}
<div class="grn">Project has been created</div>
{elseif $msg=='saved'}
<div class="grn">Project has been saved</div>
{/if}
{if $error}
