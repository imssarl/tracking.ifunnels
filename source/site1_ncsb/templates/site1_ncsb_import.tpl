...
<fieldset>
	...
	<ol>
		...
		<li>
			<label>URL<em>*</em></label><input class="required" type="text" name="arrNcsb[url]" value="{$arrNcsb.url}">
		</li>
		<li>
			<label>Main Keyword <em>*</em></label><input class="required" type="text" name="arrNcsb[main_keyword]" value="{$arrNcsb.main_keyword}">
		</li>
			<li><label for="adsenseid">Adsense ID <em>*</em></label><input name="arrNcsb[google_analytics]" type="text" id="adsenseid" value="{$arrNcsb.google_analytics}" />
		</li>		
		<li>
