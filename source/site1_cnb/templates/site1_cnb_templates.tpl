...
<form action="" method="POST" style="display:none;" enctype='multipart/form-data' id="add_plugin">
	<table>
		...
		<tr>
			<td>Editable header</td>
			<td><input type="checkbox" value="1" name="theme[flg_header]"></td>
		</tr>
		<tr>
			<td>Zip file</td>
...
<tr>
	<th width="70">
		Priority
		{if count($arrList)>1}
			{if $arrFilter.order!='priority--up'}<a href="{url name='site1_cnb' action='templates' wg='order=priority--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='priority--dn'}<a href="{url name='site1_cnb' action='templates' wg='order=priority--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}
	</th>
	<th width="100">
		Editable header
		{if count($arrList)>1}
			{if $arrFilter.order!='flg_header--up'}<a href="{url name='site1_cnb' action='templates' wg='order=flg_header--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='flg_header--dn'}<a href="{url name='site1_cnb' action='templates' wg='order=flg_header--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}
	</th>
	<th width="200">Title
		{if count($arrList)>1}
			{if $arrFilter.order!='title--up'}<a href="{url name='site1_cnb' action='templates' wg='order=title--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='title--dn'}<a href="{url name='site1_cnb' action='templates' wg='order=title--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}	
	</th>
	<th>Description</th>
	<th width="150">Added
		{if count($arrList)>1}
			{if $arrFilter.order!='added--up'}<a href="{url name='site1_cnb' action='templates' wg='order=added--up'}"><img src="/skin/i/backend/up.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/up_off.gif" width="5" height="11" alt="" />{/if}{if $arrFilter.order!='added--dn'}<a href="{url name='site1_cnb' action='templates' wg='order=added--dn'}"><img src="/skin/i/backend/down.gif" width="5" height="11" alt="" /></a>{else}<img src="/skin/i/backend/down_off.gif" width="5" height="11" alt="" />{/if}
		{/if}	
	</th>
	<th width="50">&nbsp;</th>
</tr>
...
<tr {if $k%2=='0'} class="matros"{/if}>
	...
	<td align="center">{if $v.flg_header}yes{else}no{/if}</td>
	...
	<td class="option">
		<a href="{url name='site1_cnb' action='templates'}?delete={$v.id}">del</a>
	</td>
</tr>
{/foreach}
</tbody>
