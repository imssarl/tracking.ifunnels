...
<fieldset>
	...
	<ol>
		...
		<li>
			<label>URL <em>*</em></label><input class="required" type="text" name="arrCnb[url]" >
			<p>Example: http://www.mydomain.com/myfolder/ </p>
		</li>
		<li>
			<label>Sub Folder </label><input  type="text" name="arrCnb[sub_dir]" >
			<p>Example: if www.site.com/myfolder/ is your site, input myfolder in the above field </p>
		</li>		
		<li>
			<label>Site Title <em>*</em></label><input class="required" type="text" name="arrCnb[title]">
		</li>
		<li>
