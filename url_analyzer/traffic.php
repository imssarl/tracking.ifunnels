...
{	
...

	{
		...
		$KEYWORD_MAIN_TAG["GOOGLE"] = array("<div id=res class=med>","</div>");
		...
		$KEYWORD_SUMMARY_TAG["GOOGLE"] = array('<div class="s">','</div>');

		//$KEYWORD_URL_TAG["GOOGLE"] = array('<span class=a>',' -');   
		$KEYWORD_URL_TAG["GOOGLE"] = array('<span class=gl>','</span>');
...
echo CURLOPT_URL, $KEYWORD_SOURCE_SITES[$KEYWORD_SEARCH_BY][1].urlencode($keyphrases)."&".$KEYWORD_START_VARS[$KEYWORD_SEARCH_BY][0]."=".$start;
...
$out_4=str_replace("http://"," ",$out_3[2][0]); 

$out_5="http://".$out_4;

$page .= "<a href='".strip_tags($out_5)."' TARGET='_blank'>".$out_5."</a><br><br>";
...

{
	...
	$manage = ' >> <a class="a1" href="traffic.php">Niche Traffic Locater</a> ';
...
<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
			...
			<TD align="left" class="heading1" style="font-size:15px; font-weight:bold;"><?php echo str_replace('"','',$keyphrases);?></TD>

			<td class="heading" width="20%"><a href="?process=google&amp;search=0&amp;key=<?php echo $_GET['key'];?>&amp;keyword=<?php echo $_GET['keyword'];?>&amp;datacenter=<?php echo $_GET['datacenter'];?>">Expand</a>&nbsp;&nbsp;
	...
	<tr>
			...
			?>
				 ...
				 <a href="?process=google&amp;search=1&amp;query=1&amp;key=Blogs&amp;keyword=<?php echo $_GET['keyword'];?>&amp;datacenter=<?php echo $_GET['datacenter'];?>"><?php echo '<b>'.$_GET['keyword']." "."Blogs".'</b>|';?></a>

				 <a href="?process=google&amp;search=1&amp;query=1&amp;key=Social Networks&amp;keyword=<?php echo $_GET['keyword'];?>&amp;datacenter=<?php echo $_GET['datacenter'];?>"><?php echo '<b>'.$_GET['keyword']." "."Social Networks".'</b>|';?></a>

				 <a href="?process=google&amp;search=1&amp;query=1&amp;key=Directories&amp;keyword=<?php echo $_GET['keyword'];?>&amp;datacenter=<?php echo $_GET['datacenter'];?>"><?php echo '<b>'.$_GET['keyword']." "."Directories".'</b>|';?></a>
			...
			?>
				 ...
				 <a href="?process=google&amp;search=1&amp;query=1&amp;key=Forums&amp;keyword=<?php echo $_GET['keyword'];?>&amp;datacenter=<?php echo $_GET['datacenter'];?>"><?php echo '<b>'.$_GET['keyword']." "."Forums".'</b>|';?></a>
...
<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
			...
			<TD align="center" class="heading" colspan="4" >Niche Traffic Locater</TD>
...
<tr><td>- Directories</td></tr>
	...
	<tr>
		...
		<td align="right" colspan="2" width="18%" >Keyword&nbsp;</td><td align="left"><input type="text" name="keyword" size="30"></td>
