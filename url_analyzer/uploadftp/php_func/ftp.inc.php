...
var $conn;
var $auth;
var $user_ftp = "your ftp username";
var $pwd_ftp = "your ftp password";
var $hostadd = "host IP address";
var $pasv;
var $sop;
var $connected;
  ...
  function ftp_transaction($file_path=null,$file_name=null,$file_type=null) {
       ...
       $ret = ftp_put($this->conn,$file_name.$set_file_type,$file_path,$ftp_compression) or die("conf failed, click back button");
	   if($ret == FTP_FAILED)
	   {
