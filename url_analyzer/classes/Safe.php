...
class HTML_Safe 
{
   ...
   /*  var $deleteTags = array(
	...
	// this variable is changed by ashish 
	var $deleteTags = array(
        'applet', 'base',   'basefont', 'bgsound', 'blink',  
        'embed',  'frame',  'frameset', 'ilayer', 
        'iframe', 'layer','object', 'style', 'script', 
        );
	...
	// this variable is changed by ashish 
	var $deleteTagsContent = array('script', 'style', 'xml', );
...
/*  var $protocolAttributes = array(
	...
	// this tag is changed by ashish
    var $closeParagraph = array(
          'blockquote',  'dir', 
        'dl',   'dt', 'isindex', 'listing','marquee', 
        'menu',  'multicol', 'ol','plaintext', 'pre', 
         );
