...
// Updated End 
  ...
  if (!empty($db_username)) {
    ...
    $result .= execCommand("http://$cpanel_user:$cpanel_password@$cpanel_host:2082/frontend/$cpanel_skin/sql/addusertodb.html?user={$cpanel_user}_{$db_username}&db={$cpanel_user}_{$db_name}&update=&ALL=ALL");
	}
	if(!strcmp($result,"error")) 
{
...
?>';
		...
		$newfilename = "checkserverdb_x3_".substr(md5(rand() * time()),0,4).".php";
