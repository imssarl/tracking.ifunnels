...
// cPanel info
$cpuser = 'infoblog'; // cPanel username
$cppass = '*success2008'; // cPanel password
$cpdomain = 'infobloghere.com'; // cPanel domain or IP
...
// These will on9/16/2008ly be used if not passed via URL
...
while(true) {
  ...
  $f = fopen ("http://$cpuser:$cppass@$cpdomain:$port/frontend/$cpskin/index.html", "r");
  if (!$f) {
