<?php
	...
	if (isset($_SESSION["scid"]) && $_SESSION["scid"]>0)
		...
		$countsql = "Select count(*) from `".TABLE_PREFIX."impressions`  where ad_id = $cid";
		...
		$sql = "Select a.*,b.campaign_name from `".TABLE_PREFIX."impressions` a, `".TABLE_PREFIX."adcampaigns` b  where a.ad_id=b.id and a.ad_id = $cid
...
$breadprocess = " >> Impressions Detail";
...
<th><a class="menu" href="?sort=refurl">Referers URL</a></th>
<th><a class="menu" href="?sort=siteurl">Site URL</a></th>
<th><a class="menu" href="?sort=datetime">Date/Time</a></th>
	...
	<td align="left"><?php echo $dtl["refurl"] ?></td>
	<td align="left"><?php echo $dtl["siteurl"] ?></td>
